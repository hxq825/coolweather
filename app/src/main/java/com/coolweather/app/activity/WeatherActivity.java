...
public class WeatherActivity extends Activity implements View.OnClickListener {
    ...
    private TextView publishText;//用于显示发布的时间
    ...
    private Button switchCity;//切换城市名
    ...
    /**
     * 从ShareedPreferences 文件中读取存储的天气信息,并显示到界面上
     */
